...
//     resolve: path => fetch('http://127.0.0.1:3146' + path).then(res => res.text())


// }, { wasmURL: 'esbuild.wasm' })
const compiler = new Compiler(new ServerResolver(), { wasmURL: 'esbuild.wasm' })
const code = await compiler.compile('/main.jsx', { format: 'esm' });
console.log(code);
